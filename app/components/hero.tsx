        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 order-1 lg:order-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              ...
              <a href="#contactus">
                <button className="border-2 border-slate-500/60 text-white px-8 py-4 rounded-2xl font-semibold hover:bg-slate-500/10 hover:border-slate-400 transition-all duration-300 hover:scale-105 transform backdrop-blur-sm">
                  Contact Me
                </button>
              </a>
            </div>
            ...
            <div className="flex gap-4 pt-8">
              <a
                href="#"
                className="group w-14 h-14 bg-slate-800/60 backdrop-blur-sm rounded-full flex items-center justify-center text-slate-300 hover:text-white hover:bg-gradient-to-r hover:from-slate-600 hover:to-slate-950/50 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-slate-500/30 border border-slate-700/50"
